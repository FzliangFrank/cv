...
:::{.skill custom-style='skills'}

- R-programming (Tidyverse, igrap, tmap)
- Python (Pandas, Vega Altair, ibis)
- Postgre SQL + PostGIS
- Delta Lake
...
**Network Data Utility tool.** A R-Shiny App Tool Kit for interactive network visualisation. There are several prewritten modules that enables a user to search a particular node or edges based on identity or attribute.
